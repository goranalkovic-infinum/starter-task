...
export const WrapperOptions = ({ attributes, setAttributes }) => {
	...
	return (
		<Fragment>
			{!wrapperDisable &&
				<PanelBody title={__('Block Layout', 'Unicorns')} initialOpen={false} className="custom-highlighted-panel">
					...
					{wrapperUseShowControl &&
						<ToggleControl
							label={wrapperUse ? __('Wrapper Enabled', 'Unicorns') : __('Wrapper Disabled', 'Unicorns')}
							checked={wrapperUse}
					...
					{(wrapperUse && wrapperUseSimpleShowControl) &&
						<ToggleControl
							label={wrapperUseSimple ? __('Wrapper Simple Enabled', 'Unicorns') : __('Wrapper Simple Disabled', 'Unicorns')}
